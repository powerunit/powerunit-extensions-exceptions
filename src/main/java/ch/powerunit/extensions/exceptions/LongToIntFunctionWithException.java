 ...
 */
@FunctionalInterface
public interface LongToIntFunctionWithException<E extends Exception> extends
		PrimitiveReturnExceptionHandlerSupport<LongToIntFunction, LongToIntFunctionWithException<E>>, IntDefaultValue {
