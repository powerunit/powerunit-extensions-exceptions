 ...
 */
@FunctionalInterface
public interface LongPredicateWithException<E extends Exception> extends
		PrimitiveReturnExceptionHandlerSupport<LongPredicate, LongPredicateWithException<E>>, BooleanDefaultValue {
